...
export function InstanceDisplay(props: { instance: InstanceObject }) {
    ...
    return (
        <Box flexDirection="column">
            ...
            <Row headWidth={10} head="ssh" value={props.instance.can_connect ? "ready" : "not ready"} />
            <Row headWidth={10} head="ssh port" value={props.instance.ssh_port?.toString() ?? "-"} />
            <Row headWidth={10} head="ssh cmd" value={`sf ssh ${props.instance.id}`} />
