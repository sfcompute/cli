...
type CredentialsResponse = operations["getV0Credentials"]["responses"][200]["content"]["application/json"];
type CredentialsList = CredentialsResponse["data"];
type BaseK8sCredential = Extract<CredentialsList[number], { object: "k8s_credential" }>;
